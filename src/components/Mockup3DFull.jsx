...
export default function Mockup3DPro({ initialColor = "#ffffff" }) {
  ...
  // 2. Bild hochladen & Textur anwenden
  ...
  // 3. Transformationen (Drag, Zoom, Rotate)
